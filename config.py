...
# database type
db_type = 'asvspoof_eval' # asvspoof_eval_laundered or in_the_wild or asvspoof_train or asvspoof_train_laundered or asvspoof_eval, asvspoof5_train_laundered, asvspoof5_eval_laundered
...
# protocol_filenames = ['ASVSpoof5_train_laundered_protocol_10_percent.txt', 'ASVspoof5.dev.metadata.txt']        # for asvspoof5
